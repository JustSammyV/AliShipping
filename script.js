...
//un
    ...
    informacionDiv.innerHTML = "<p>Método de envío: Cainiao Super Economy Global / Mail Americas Standard<p/> <p>Transportista en China: <a href='https://global.cainiao.com'>Cainiao</a>, <a href='https://track.4px.com'>4PX Express</a> y <a href='https://mailamericas.com/tracking'>Mail Americas</a></p> <p>Transportista en Chile: Desconocido<p/> <p>Seguimiento por AliExpress: Sí<p/> <p>Seguimiento en Chile: No<p/> <p>Tiempo estimado de entrega: 3 a 12 meses<p/>";
	codigoValido = true;
...
//yan
	} else if (codigo.length === 13 && codigoLowercase.startsWith("vr") || codigoLowercase.startsWith("ug") && codigoLowercase.endsWith("yp")) {
	informacionDiv.innerHTML = "<p>Método de envío: Yanwen (special standard)<p/> <p>Transportista en China: <a href='https://global.cainiao.com'>Cainiao</a> y <a href='https://www.yw56.com.cn/en/'>Yanwen</a></p> <p>Transportista en Chile: <a href='https://correos.cl'>Correos Chile</a> o <a href='http://kd.hyuusoft.com/wxorder/new_detail_miya.jsp'>Mia Express</a><p/> <p>Seguimiento por AliExpress: Sí<p/> <p>Seguimiento en Chile: Sí<p/> <p>Tiempo estimado de entrega: 3 a 7 semanas<p/> <p>Para determinar que empresa repartirá, pon el código en Postal Ninja y busca el código alternativo que salga. Cópialo y pégalo en esta página</p>";
	codigoValido = true;
		
//533
	} else if (codigo.length === 28 && codigo.startsWith("533")) {
	informacionDiv.innerHTML = "<p>Método de envío: Mail Americas Registered<p/> <p>Transportista en China: <a href='https://mailamericas.com/tracking'>Mail Americas</a></p> <p>Transportista en Chile: <a href='https://www.blue.cl'>BluExpress</a><p/> <p>Seguimiento por AliExpress: Sí<p/> <p>Seguimiento en Chile: Sí<p/> <p>Tiempo estimado de entrega: 2 a 5 semanas<p/> <p>Para obtener el código de BluExpress, al código quítale los primeros 5 dígitos. Los 10 siguientes serán el código de BluExpress</p>";
	codigoValido = true;
		
//hjyt
	} else if (codigo.length === 17 && codigoLowercase.startsWith("hjyte") && codigoLowercase.endsWith("yq")){
	informacionDiv.innerHTML = "<p>Transportista en China: <a href='http://120.78.64.88:8082/en/trackIndex.htm'>HJYT Express</a></p> <p>Transportista en Chile: <a href='https://www.correos.cl'>Correos Chile</a><p/> <p>Seguimiento por AliExpress: No<p/> <p>Seguimiento en Chile: No<p/> <p>Tiempo estimado de entrega: 2 a 5 semanas<p/>";
	codigoValido = true
		
//sf
	} else if (codigo.length === 15 && codigoLowercase.startsWith("sf")) {
	informacionDiv.innerHTML = "<p>Transportista en China: <a href='https://www.sf-express.com/we/ow/chn/en/waybill/list'>SF Express</a></p> <p>Transportista en Chile: Desconocido<p/> <p>Seguimiento por AliExpress: Aveces<p/> <p>Seguimiento en Chile: Sí<p/> <p>Tiempo estimado de entrega: Desconocido<p/>";
	codigoValido = true
		
//yun
	} else if (codigo.length === 18 && codigoLowercase.startsWith("yt")) {
	informacionDiv.innerHTML = "<p>Transportista en China: <a href='https://www.yuntrack.com/parcelTracking'>Yun Express</a></p> <p>Transportista en Chile: <a href='https://centrodeayuda.chilexpress.cl'>Chilexpress</a><p/> <p>Seguimiento por AliExpress: Aveces<p/> <p>Seguimiento en Chile: Sí<p/> <p>Tiempo estimado de entrega: 2 a 4 semanas<p/>";
	codigoValido = true
